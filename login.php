                        ...
                        <div class="col-xs-12">
                            <div class="bradcaump__inner">
                                <nav class="bradcaump-inner">
                                  ...
                                  <span class="breadcrumb-item active">Login or Register</span>
                                </nav>
                            </div>
                        </div>
                    </div>
                                ...
                                <form id="contact-form" method="post">
                                    <div class="single-contact-form">
                                        <div class="contact-box name">
                                            <input type="email" id="login_email" name="login_email" placeholder="Your Email*" style="width:100%">
                                        </div>
                                        <span class='feild_error login_feild_error' id="login_email_error"></span>
                                    </div>
                                    <div class="single-contact-form">
                                        <div class="contact-box name">
                                            <input type="text" id="login_password" name="login_password" placeholder="Your Password*" style="width:100%">
                                        </div>
                        ...
                        <div class="contact-form-wrap mt--60">
                            ...
                            <div class="col-xs-12">
                                <form id="register-form" method="post">
                                    ...
                                    <div class="single-contact-form">
                                        <div class="contact-box name">
                                            <input type="text" id="password" name="password" placeholder="Your Password*" style="width:100%">
                                        </div>
